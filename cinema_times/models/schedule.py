...
class Schedule(models.Model):
    ...
    video_type_id = models.ForeignKey(VideoType, null=True, blank=True, default=None)
    audio_type_id = models.ForeignKey(AudioType, null=True, blank=True, default=None)
